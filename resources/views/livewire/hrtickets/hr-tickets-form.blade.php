<div>
    ...
    <form wire:submit.prevent="submit" method="POST" class="flex flex-col gap-4 p-8 mt-10 bg-white rounded-lg"  x-data="{ typeOfTicket: $wire.entangle('type_of_ticket'), typeOfRequest: $wire.entangle('type_of_request'), subTypeOfRequest: $wire.entangle('sub_type_of_request'), typeOfHrConcern: $wire.entangle('type_of_hrconcern')}">
        ...
        {{-- Other Information  --}}
        <template x-if="((typeOfTicket === 'Overtime Form') || (typeOfTicket === 'Internal Control' || typeOfTicket === 'HR Operations') && typeOfRequest !== null) || (typeOfTicket === 'HR Internal' && typeOfRequest !== null && subTypeOfRequest !== null)">
            <div>
            <hr class="my-2 border-gray-300">
            <div class="flex flex-col gap-4">
                ...
                <template x-if="typeOfTicket === 'Overtime Form'">
                    {{-- @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Request for Employee Files") --}}
                    <div class="mt-2 grid grid-cols-1 min-[902px]:grid-cols-6 gap-4">
                        ...
                        <div id="request_requested_container" class=" col-span-1 min-[902px]:col-span-2">
                            ...
                            <select id="request_requested" name="request_requested" wire:model.live="request_requested"
        ...
        document.addEventListener('livewire:init', function () {
            Livewire.on('trigger-reroute', () => {
                ...
                setTimeout(() => {
                    ...
                    }, 2000); // Delay the redirect by 3000ms (to match animation duration)
