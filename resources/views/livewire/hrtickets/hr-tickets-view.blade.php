            ...
            <div class="flex flex-col gap-4">
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Tools and Equipment")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            ...
                            {{-- <div class="grid w-full grid-cols-2  border border-gray-300 rounded-lg shadow-inner bg-gray-50"> --}}
                                {{-- <div>
                                ...
                                <div>
                                    <!-- Radio Buttons -->
                                    <input type="radio" class="disabled-select border-gray-500" id="Old/Existing Unit" name="condition_availability" value="Old/Existing Unit" {{ $condition_availability == 'Old/Existing Unit' ? 'checked' : '' }} disabled>
                                    ...
                                    <span class="text-sm font-medium mt-2">
                                        @if($condition_availability == 'Old/Existing Unit')
                                            Selected: Old/Existing Unit
                                        @endif
                                    </span>
                                </div> --}}
                                <input type="text" name="purpose" id="purpose" value="{{$condition_availability}}" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5">
                                {{-- <span class="text-sm font-medium mt-2">
                                    @if($condition_availability == 'Old/Existing Unit')
                                        Selected: Old/Existing Unit
             ...
             @if ($status != "Cancelled")
                <div x-data="{ openCancelModal: false }">
                    ...
                    <div x-data="{ showToast: false }" @trigger-notification.window="showToast = true; setTimeout(() => showToast = false, 3000)">
                        <div id="toast-success" tabindex="-1" class="fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-gray-800 bg-opacity-50" x-show="showToast">
                            <!-- No transition on this outer div, so the background doesn't transition -->
                            <div id="toast-success-checkin" class="fixed flex items-center justify-center w-full max-w-xs p-4 text-gray-500 transform -translate-x-1/2 bg-white rounded-lg shadow top-4 left-1/2 z-60" role="alert"
                                ...
                                <button id="close-toast-checkin" type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8" aria-label="Close" @click="showToast = false">
