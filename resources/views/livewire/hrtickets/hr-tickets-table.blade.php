    ...
    <div class="p-4 rounded-lg ">
        <nav class="flex mb-4" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{route('HrTicketsTable', ['type' => $type])}}" class="text-sm font-semibold text-gray-900 ms-1 hover:text-customRed md:ms-2 ">HR Tickets</a>
                </div>
            </li>
            </ol>
        </nav>
        <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl ">HR Tickets</h2>
        ...
        <div class="w-full pb-4 overflow-x-auto bg-white rounded-t-lg shadow-md" >
            <div class="flex flex-wrap items-center justify-between p-4 pb-4 space-y-4 flex-column sm:flex-row sm:space-y-0">
                <div>
                    ...
                    {{-- Status Filter --}}
                    <button id="dropdownRadioButton" data-dropdown-toggle="statusDropDown" class=" z-50 inline-flex items-center hover:text-white text-gray-900 bg-navButton  h-10 focus:outline-none focus:text-white focus:bg-customRed  hover:bg-customRed focus:ring-1 shadow focus:ring-customRed font-medium rounded-lg text-sm px-3 py-1.5" type="button">
                        <svg class="w-3 h-3 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm3.982 13.982a1 1 0 0 1-1.414 0l-3.274-3.274A1.012 1.012 0 0 1 9 10V6a1 1 0 0 1 2 0v3.586l2.982 2.982a1 1 0 0 1 0 1.414Z"/>
                            </svg>
                        {{$statusFilterName}}
                                            ...
                                            <div x-show="isOpen" :class="{ 'left-0': isLeftAligned, 'right-0': !isLeftAligned }" class="absolute z-40 mt-2 bg-white divide-y divide-gray-300 rounded-lg shadow w-44 " id="dropdown{{ $loop->index }}">
                                                <!-- Dropdown content -->
                                                    <ul class="py-2 text-sm text-gray-700 divide-y-2 ">
                                                        <li>
                                                            <a onclick="location.href='{{ route('HrTicketsView', ['index' => $hrticket->uuid]) }}'" class="block px-4 py-2 cursor-pointer hover:bg-gray-100 ">View</a>
                                                        </li>
                                                    </ul>
