                        ...
                        @enderror
                                    ...
                                    <h2 class="font-bold text-md text-customRed"> School Information</h2>
                                        ...
                                        <div class="grid grid-cols-1 ml-2 min-[902px]:grid-cols-2 gap-4 col-span-3 ">
                                            <div class="w-full ">
                                                ...
                                                <input type="text" name="high_school_school" id="high_school_school"  wire:model="high_school_school" disabled
                                                    class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    ntd="" >
                                            ...
                                            <div class="w-full ">
                                                ...
                                                <input type="date" name="high_school_date_graduated" id="high_school_date_graduated" wire:model="high_school_date_graduated" disabled
                                                    class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    ntd="" >
                                        ...
                                        <div class="grid grid-cols-1 ml-2 min-[902px]:grid-cols-3 gap-4 col-span-3 pb-4">
                                            <div class="w-full ">
                                                <label for="college_school"
                                                    class="block mb-2 text-sm font-medium text-customGray whitespace-nowrap">School <span class="text-red-600">*</span></label>
                                                <input type="text" name="college_school" id="college_school"  wire:model="college_school" disabled
                                                    class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    ntd="" >
                                                ...
                                                @enderror
                                                                        ...
                                                                        <div class="w-full ">
                                                                            ...
                                                                            <input type="text" name="college_course" id="college_course" wire:model="college_course" disabled
                                                                                class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                                ntd="" >
                                                ...
                                                @enderror
                                                                        ...
                                                                        <div class="w-full ">
                                                                            <label for="college_date_graduated"
                                                                                class="block mb-2 text-sm font-medium text-customGray whitespace-nowrap dark:text-white">Date Graduated <span class="text-red-600">*</span></label>
                                                                            <input type="date" name="college_date_graduated" id="college_date_graduated" wire:model="college_date_graduated" disabled
                                                                                class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                                ntd="" >
                                            ...
                                            <div class="grid grid-cols-1 ml-2 min-[902px]:grid-cols-3 gap-4 col-span-3 pb-4">
                                                <div class="w-full ">
                                                    <label for="vocational_school"
                                                        class="block mb-2 text-sm font-medium text-customGray whitespace-nowrap">School <span class="text-red-600">*</span></label>
                                                    <input type="text" name="vocational_school" id="vocational_school"  wire:model="vocational_school" disabled
                                                        class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        ntd="" >
                                                ...
                                                <div class="w-full ">
                                                    ...
                                                    <input type="text" name="vocational_course" id="vocational_course" wire:model="vocational_course" disabled
                                                        class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        ntd="" >
                                                ...
                                                <div class="w-full ">
                                                    <label for="vocational_date_graduated"
                                                        class="block mb-2 text-sm font-medium text-customGray whitespace-nowrap dark:text-white">Date Graduated <span class="text-red-600">*</span></label>
                                                    <input type="date" name="middlename" id="vocational_date_graduated" wire:model="vocational_date_graduated" disabled
                                                        class="bg-gray-50 border border-gray-300 text-customGray text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        ntd="" >
                            ...
                            <div class="grid grid-cols-1 w-full col-span-3 gap-4 min-[902px]:grid-cols-3 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                <div class="grid grid-cols-1 col-span-3 gap-4 ">
                                     <div>
                                     <div class="grid grid-cols-1 w-full col-span-3 gap-4 min-[902px]:grid-cols-2">
                    <h2 class="block mb-2 text-md font-medium text-customGray col-span-1 min-[902px]:col-span-2"> Microsoft Folder Link for  <span class="text-customRed"><b>201 Files and Other Necessary Files</b></span> <span class="text-red-600">*</span></h2>
