                ...
                <div class="inline-block min-w-full box-border">
                    <div class="flex  flex-wrap pb-1 items-center justify-between w-full  space-y-4 min-[567px]:space-y-0  flex-column sm:flex-row ">
                        ...
                        <div class="relative max-[567px]:pl-1  ">
                            ...
                            <input type="text" id="table-search" wire:model.live.debounce.250ms="search" class="block p-2 text-sm rounded-lg shadow-inner ps-10 bg-gray-50 focus:ring-customRed focus:border-customRed border-text max-[567px]:w-264  w-64" placeholder="Search like: January">
                        </div>
                    </div>
                </div>
            </div>
