<div class="main-content">
    <div class="p-4 rounded-lg dark:border-gray-700">
        ...
        <div class="p-4 bg-gray-100 w-full rounded-b-lg">
         ...
         <!-- Loading screen -->
         <div wire:loading wire:target="submit, cancelForm, search, date_filter, status_filter" class="fixed inset-x-0 top-1/4 flex justify-center pointer-events-none z-50">
            <div class="z-50 mt-4">
