                        ...
                        @else
                            ...
                            @endphp
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            @if ($hrticket->status != "Cancelled")
                                                <div class="hidden  top-0 right-0 mt-2 z-40 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                            <li>
                                                                <a id="" onclick="location.href='{{ route('ApproveLeaveRequestForm', ['index' => $hrticket->form_id]) }}'"  class="block cursor-pointer px-4 py-2 cursorpointer hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                            </li>
                                                    </ul>
                                                    <div class="py-2">
                                    ...
                                    <div id="popup-modal_{{ $hrticket->form_id }}" tabindex="-1" class="hidden fixed top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center overflow-y-auto overflow-x-hidden w-full h-full bg-gray-800 bg-opacity-50">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5">
                                                    <div class="p-4 md:p-5 text-center">
                                                        ...
                                                        <button wire:click="cancelForm('{{$hrticket->form_id}}')"  class="text-white bg-red-600 hover:bg-red-800   font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                            Yes
                                                        </button>
