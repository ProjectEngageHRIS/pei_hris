    ...
    <form method="GET" class="flex flex-col gap-4 p-8 mt-10 bg-white rounded-lg">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="grid grid-cols-1 min-[902px]:grid-cols-6 gap-4">
                <div class="col-span-1 min-[902px]:col-span-2">
                    <label for="firstname" class="block mb-2 text-sm font-medium disabled-select whitespace-nowrap">First name</label>
                ...
                <div class="col-span-1 min-[902px]:col-span-2">
                    <label for="middlename" class="block mb-2 text-sm font-medium disabled-select whitespace-nowrap">Middle name</label>
                    <input type="text" name="middlename" id="middlename" value="{{$middle_name}}" required="" disabled
                        class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5">
                </div>
                <div class="col-span-1 min-[902px]:col-span-2">
                    <label for="lastname" class="block mb-2 text-sm font-medium disabled-select whitespace-nowrap">Last name</label>
                    <input type="text" name="lastname" id="lastname"  value="{{$last_name}}" required="" disabled
                        class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5">
                </div>
                <div class="col-span-1 min-[902px]:col-span-3">
                    <label for="employee_email" class="block mb-2 text-sm font-medium disabled-select whitespace-nowrap">Employee Email</label>
                    <input type="text" name="employee_email" id="employee_email"  value="{{$employee_email}}" required="" disabled
                        class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5">
                </div>
                <div class="col-span-1 min-[902px]:col-span-3">
                    <label for="employee_id" class="block mb-2 text-sm font-medium disabled-select whitespace-nowrap">Employee ID</label>
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-4">
                <div class="col-span-2">
                    <label for="application_date" class="block mb-2 text-sm font-medium disabled-select">Date of Filing</label>
                    <input type="date" wire:model="application_date" class="bg-gray-50 border shadow-inner border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5"
                        placeholder="Date of Filing" required disabled>
                </div>
                <div class="col-span-2">
                    <label class="block mb-2 text-sm font-medium disabled-select">Ticket Type</label>
                ...
                @if ($type_of_ticket == "HR Internal")
                    <div id="type_of_request_container" class="col-span-2">
                        <label class="block mb-2 text-sm font-medium disabled-select"> Type of HR Internal Request</label>
                    ...
                    @if ($type_of_request == "HR")
                        <div id="sub_type_of_request_container" class="col-span-2">
                            <label class="block mb-2 text-sm font-medium disabled-select">Type of HR Requests</label>
                            <select name="sub_type_of_request" wire:model.live="sub_type_of_request" required disabled
                                ...
                                <option value="HMO-related Concern">HMO-related Concern</option>
                    ...
                    @elseif ($type_of_request == "Office Admin")
                        <div id="sub_type_of_request_container" class="col-span-2">
                            <label class="block mb-2 text-sm font-medium disabled-select">Type of Office Admin Requests</label>
                            <select name="sub_type_of_request" wire:model.live="sub_type_of_request" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                    ...
                    @elseif ($type_of_request == "Procurement")
                        <div id="sub_type_of_request_container" class="col-span-2">
                            <label class="block mb-2 text-sm font-medium disabled-select">Type of Procurement Requests</label>
                            <select name="sub_type_of_request" wire:model.live="sub_type_of_request" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-sm shadow-inner rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "Internal Control")
                    <div id="type_of_request_container" class="col-span-2 lg:col-start-2">
                        <label class="block mb-2 text-sm font-medium disabled-select">Type of Internal Control Request</label>
                        <select name="type_of_request" wire:model.live="type_of_request" required wire:change="resetSubTypeOfRequest" disabled
                            class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg w-full p-2.5">
                            <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "HR Operations")
                    <div id="type_of_request_container" class="col-span-2 lg:col-start-2">
                        <label class="block mb-2 text-sm font-medium disabled-select">Type of HR Operations Request</label>
                        <select name="type_of_request" wire:model.live="type_of_request" required wire:change="resetSubTypeOfRequest" disabled
                            class="bg-gray-50 border border-gray-300 disabled-select text-sm shadow-inner rounded-lg block w-full p-2.5">
                            <option selected>Select</option>
        ...
        @if ((($type_of_ticket == "Internal Control" || $type_of_ticket == "HR Operations") && !is_null($type_of_request)) || ($type_of_ticket == "HR Internal" && !is_null($type_of_request) && !is_null($sub_type_of_request)))
            ...
            <div class="flex flex-col gap-4">
                ...
                @if ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Certificate of Employment")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Purpose of Requesting CoE</label>
                            <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                            </textarea>
                            @error('purpose')
                        ...
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_request" class="block mb-2 text-sm font-medium disabled-select">Commutation</label>
                            <div class="grid w-full grid-cols-2 p-4 border border-gray-300 shadow-inner rounded-lg bg-gray-50">
                                <div>
                                    <input type="radio" class="disabled-select border-gray-500" name="type_of_hrconcern" id="with_compensation" wire:model="type_of_hrconcern" value="With Compensation" disabled>
                                    <label for="with_compensation" class="text-sm font-medium disabled-select">With Compensation</label>
                                </div>
                                <div>
                                    <input type="radio" class="ml-2 disabled-select border-gray-500" id="without_compensation" name="type_of_hrconcern" wire:model="type_of_hrconcern" value="Without Compensation" disabled>
                                    <label for="without_compensation" class="text-sm font-medium disabled-select">Without Compensation</label><br>
                                </div>
                            </div>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "HMO-related Concern")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm shadow-inner font-medium disabled-select">Type of HMO Concern</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_request" wire:model.live="type_of_hrconcern" class="bg-gray-50 border border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">HMO Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select shadow-inner bg-gray-50 rounded-lg border border-gray-300">
                                </textarea>
                                @error('purpose')
                                    <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('purpose_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('purpose_container').focus();">
                                        <span class="text-xs text-red-500">{{$message}}</span>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">HMO Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Payroll-related Concerns")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium disabled-select">Payroll Date</label>
                            <input class="bg-gray-50 border border-gray-300 shadow-inner disabled-select text-sm rounded-lg block w-full p-2.5"
                        ...
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium disabled-select">Type of Payroll Concern</label>
                            <div id="type_of_hrconcern_container">
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Payroll Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">Payroll Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Leave Concerns")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium disabled-select">Type of Leave Request</label>
                            <div id="type_of_hrconcern_container">
                                <select name="type_of_request" wire:model.live="type_of_hrconcern" disabled
                                    class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Leave Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">Leave Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Request for Consultation")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium disabled-select">Type of Consultation Request</label>
                            <div id="type_of_hrconcern_container">
                                <select name="type_of_request" wire:model.live="type_of_hrconcern" disabled
                                    class="bg-gray-50 border border-gray-300 disabled-select shadow-inner  text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Consultation Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Request for a Meeting")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        ...
                        <div id="request_requested_container" class="col-span-1">
                            <label for="request_requested" class="block mb-2 text-sm font-medium disabled-select">Target Person</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="request_requested" wire:model="request_requested" class="bg-gray-50 border shadow-inner  border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Purpose of Meeting</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Certificate of Remittances")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium disabled-select">Type of Remittance Certificate</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border shadow-inner  border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div class="col-span-1">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium disabled-select">Account Assigned</label>
                            <div id="request_assigned_container">
                                <select disabled name="request_assigned" wire:model.live="request_assigned" class="bg-gray-50 border shadow-inner border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Purpose of Requesting</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select shadow-inner bg-gray-50 rounded-lg border border-gray-300">
                                </textarea>
                        ...
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium disabled-select">Date Start</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Government-Mandated Benefits Concern")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium disabled-select">Type of GMR Concern</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border shadow-inner border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">GMR Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Messengerial")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-6">
                        <div class="col-span-1 lg:col-span-2">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium shadow-inner disabled-select"> Type of Messengerial Request</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="request_requested_container" class="col-span-1 lg:col-span-2">
                            <label for="request_requested" class="block mb-2 text-sm font-medium disabled-select"> Company </label>
                        ...
                        <div id="request_assigned_container" class="col-span-1 lg:col-span-2">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium disabled-select">Contact Person</label>
                        ...
                        <div id="request_others_container"  class="col-span-1 lg:col-span-3">
                            <label for="request_extra" class="block mb-2 text-sm font-medium disabled-select">Address of Messengerial Destination</label>
                        ...
                        <div class="col-span-1 lg:col-span-3">
                            <label for="request_date" class="block mb-2 text-sm font-medium disabled-select">Date of Messengerial Pick Up or Send Off</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Repairs/Maintenance")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium disabled-select">Type of Repairs and Maintenance Request </label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border shadow-inner border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Concerned Area</label>
                            <div id="purpose">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Book a Car")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium disabled-select">Date and Time of Departure</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-sm rounded-lg shadow-inner block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                                    <span class="text-xs text-red-500">{{$message}}</span>
                                </div>
                        ...
                        <div class="col-span-1">
                            <label for="request_requested" class="block mb-2 text-sm font-medium disabled-select">Date and Time of Pick-Up</label>
                        ...
                        <div id="account_client_hr_ops_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Passenger/s Name</label>
                            <div id="purpose">
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Address of Destination</label>
                            <div id="purpose">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Book a Meeting Room")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium disabled-select">Start Date</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                        ...
                        <div class="col-span-1">
                            <label for="request_requested" class="block mb-2 text-sm font-medium disabled-select">End Date</label>
                            <input type="date" name="request_requested" id="request_requested" wire:model.live="request_requested" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_requested')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('request_requested_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('request_requested_container').focus();">
                        ...
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium disabled-select">Type of Room</label>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Purpose of Booking</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-y-4 gap-x-8">
                        <div class="grid grid-cols-1 col-span-1 gap-4">
                            <div id="supplies_request.ballpen_black_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.ballpen_black" class="text-sm font-medium disabled-select">Ballpen Black</label>
                                    <input type="number" id="supplies_request.ballpen_black" name="supplies_request.ballpen_black" wire:model="supplies_request.ballpen_black" disabled
                                        class="p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                            ...
                            <div id="supplies_request.ballpen_blue_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.ballpen_blue" class="text-sm font-medium disabled-select">Ballpen Blue</label>
                            ...
                            <div id="supplies_request.ballpen_red_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.ballpen_red" class="text-sm font-medium disabled-select">Ballpen Red</label>
                            ...
                            <div id="supplies_request.pencil_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.pencil" class="text-sm font-medium disabled-select">Pencil</label>
                            ...
                            <div id="supplies_request.highlighter_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.highlighter" class="text-sm font-medium disabled-select">Highlighter</label>
                            ...
                            <div id="supplies_request.permanent_marker_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.permanent_marker" class="text-sm font-medium disabled-select">Permanent Marker</label>
                            ...
                            <div id="supplies_request.correction_tape_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.correction_tape" class="text-sm font-medium disabled-select">Correction Tape</label>
                            ...
                            <div id="supplies_request.l_green_exp_folder_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.l_green_exp_folder" class="text-sm font-medium disabled-select">Green Expandable Folder (L)</label>
                            ...
                            <div id="supplies_request.s_green_exp_folder_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.s_green_exp_folder" class="text-sm font-medium disabled-select">Green Expandable Folder (S)</label>
                            ...
                            <div id="supplies_request.l_brown_exp_folder_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.l_brown_exp_folder" class="text-sm font-medium disabled-select">Brown Expandable Folder (L)</label>
                            ...
                            <div id="supplies_request.s_brown_exp_folder_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.s_brown_exp_folder" class="text-sm font-medium disabled-select">Brown Expandable Folder (S)</label>
                            ...
                            <div id="supplies_request.scissors_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.scissors" class="text-sm font-medium disabled-select">Scissors</label>
                            ...
                            <div id="supplies_request.white_envelope_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.white_envelope" class="text-sm font-medium disabled-select">White Envelope</label>
                        ...
                        <div class="grid grid-cols-1 col-span-1 gap-4">
                            <div id="supplies_request.calculator_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.calculator" class="text-sm font-medium disabled-select">Calculator</label>
                            ...
                            <div id="supplies_request.binder_two_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.binder_two" class="text-sm font-medium disabled-select">Binder Clips (2")</label>
                            ...
                            <div id="supplies_request.binder_one_fourth_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.binder_one_fourth" class="text-sm font-medium disabled-select">Binder Clips (1 1/4")</label>
                            ...
                            <div id="supplies_request.binder_three_fourth_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.binder_three_fourth" class="text-sm font-medium disabled-select">Binder Clips (3/4")</label>
                            ...
                            <div id="supplies_request.l_metal_clips_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.l_metal_clips" class="text-sm font-medium disabled-select">Metal Paper Clips (L)</label>
                            ...
                            <div id="supplies_request.s_metal_clips_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.s_metal_clips" class="text-sm font-medium disabled-select">Metal Paper Clips (L)</label>
                            ...
                            <div id="supplies_request.stapler_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.stapler" class="text-sm font-medium disabled-select">Stapler</label>
                            ...
                            <div id="supplies_request.stapler_wire_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.stapler_wire" class="text-sm font-medium disabled-select">Stapler Wire</label>
                            ...
                            <div id="supplies_request.scotch_tape_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.scotch_tape" class="text-sm font-medium disabled-select">Scotch Tape</label>
                            ...
                            <div id="supplies_request.l_brown_envelope_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.l_brown_envelope" class="text-sm font-medium disabled-select">Brown Envelope (L)</label>
                            ...
                            <div id="supplies_request.s_brown_envelope_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.s_brown_envelope" class="text-sm font-medium disabled-select">Brown Envelope (S)</label>
                            ...
                            <div id="supplies_request.post_it_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.post_it" class="text-sm font-medium disabled-select">Post It</label>
                            ...
                            <div id="supplies_request.white_folder_container">
                                <div class="grid items-center grid-cols-2">
                                    <label for="supplies_request.white_folder" class="text-sm font-medium disabled-select">White Folder</label>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Procurement" && $sub_type_of_request == "Request for Quotation")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium disabled-select">Quotation Specifications</label>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Purpose of Request</label>
                            <div id="purpose">
                                <textarea type="text" rows="4" id="purpose" name="purpose" wire:model="purpose" placeholder="Enter your answer here." disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 rounded-lg shadow-inner border border-gray-300">
                                </textarea>
                                @error('purpose')
                                    <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('purpose_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('purpose_container').focus();">
                                        <span class="text-xs text-red-500">{{$message}}</span>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">Quotation Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Procurement" && $sub_type_of_request == "Request to Buy/Book/Avail Service")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium disabled-select">Product/Service Specifications</label>
                            <div id="type_of_hrconcern">
                                <textarea type="text" rows="2" id="type_of_hrconcern" name="type_of_hrconcern" wire:model="type_of_hrconcern" placeholder="Enter your answer here." disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">Service Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Reimbursements")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium disabled-select">Cut-Off Date</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Reimbursement Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 rounded-lg shadow-inner border border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">Reimbursement Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" placeholder="(payslips,timesheet.etc.)" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 rounded-lg border shadow-inner border-gray-300">
                                </textarea>
                                @error('request_link')
                                    <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('request_link_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('request_link_container').focus();">
                                        <span class="text-xs text-red-500">{{$message}}</span>
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Tools and Equipment")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="condition_availability" class="block mb-2 text-sm font-medium disabled-select">Condition/Availability</label>
                            <div class="grid w-full grid-cols-2 p-4 border border-gray-300 rounded-lg shadow-inner bg-gray-50">
                                <div>
                                    <input disabled type="radio" class="disabled-select border-gray-500" name="condition_availability" id="new" wire:model="condition_availability" value="New">
                                    <label for="New" class="text-sm font-medium disabled-select">New</label>
                                </div>
                                <div>
                                    <input disabled type="radio" class="disabled-select border-gray-500" id="Old/Existing Unit" name="condition_availability" wire:model="condition_availability" value="Old/Existing Unit">
                                    <label for="Old/Existing Unit" class="text-sm font-medium disabled-select">Old/Existing Unit</label><br>
                                </div>
                            </div>
                            @error('type_of_hrconcern')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('type_of_hrconcern_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('type_of_hrconcern_container').focus();">
                        ...
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label class="block mb-2 text-sm font-medium disabled-select">Equipment Type</label>
                            <select disabled id="type_of_hrconcern" name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 shadow-inner border border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Cash Advance")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium disabled-select">Date of Cash Advance Request</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">Cash Advance Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Liquidation")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Liquidation Coverage</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 rounded-lg border shadow-inner  border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium disabled-select">Liquidation Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Performance Monitoring Request")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="type_of_pe_hr_ops" class="block mb-2 text-sm font-medium disabled-select">Type of Performance Monitoring Request</label>
                            <div id="type_of_pe_hr_ops_container">
                                <select disabled name="type_of_pe_hr_ops" wire:model.live="type_of_pe_hr_ops" class="bg-gray-50 border shadow-inner border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div class="col-span-1">
                            <label for="account_client_hr_ops" class="block mb-2 text-sm font-medium disabled-select">Type of Client's Account</label>
                            <div id="account_client_hr_opscontainer">
                                <select disabled name="account_client_hr_ops" wire:model.live="account_client_hr_ops" class="bg-gray-50 border shadow-inner border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Incident Report")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_hrconcerns" class="block mb-2 text-sm font-medium disabled-select">Level of Offense</label>
                            <div class="grid w-full grid-cols-3 p-4 border border-gray-300 rounded-lg shadow-inner bg-gray-50">
                                <div>
                                    <input disabled type="radio" class="disabled-select border-gray-500" name="High" id="new" wire:model="type_of_hrconcern" value="High">
                                    <label for="High" class="text-sm font-medium disabled-select">High</label>
                                </div>
                                <div>
                                    <input disabled type="radio" class="disabled-select border-gray-500" id="Medium" name="type_of_hrconcern" wire:model="type_of_hrconcern" value="Medium">
                                    <label for="Medium" class="text-sm font-medium disabled-select">Medium</label><br>
                                </div>
                                <div>
                                    <input disabled type="radio" class="disabled-select border-gray-500" id="Low" name="type_of_hrconcern" wire:model="type_of_hrconcern" value="Low">
                                    <label for="Low" class="text-sm font-medium disabled-select">Low</label><br>
                                </div>
                            </div>
                            @error('type_of_hrconcern')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('type_of_hrconcern_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('type_of_hrconcern_container').focus();">
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Incident Report</label>
                            <div id="purpose">
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Request for Issuance of Notice/Letter")
                    <div class="grid grid-cols-1 gap-4">
                        <div id="type_of_hrconcern_container">
                            <label class="block mb-2 text-sm font-medium disabled-select">Type of Notice</label>
                            <select disabled id="type_of_hrconcern" name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border shadow-inner border-gray-300 disabled-select text-sm rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Request for Employee Files")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Purpose of Employee Files</label>
                            <div id="purpose">
                                <textarea type="text" rows="5" id="purpose" name="purpose" wire:model="purpose" placeholder="(Please write the description)" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 rounded-lg border shadow-inner border-gray-300">
                                </textarea>
                        ...
                        <div id="request_requested_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium disabled-select">Document/s Needed</label>
                            <div id="request_requested">
                                <textarea type="text" rows="5" id="request_requested" name="request_requested" wire:model="request_requested" disabled
                                    class="block p-2.5 w-full text-sm disabled-select bg-gray-50 rounded-lg border border-gray-300">
                                </textarea>
                                @error('request_requested')
                                    <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('request_requested_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('request_requested_container').focus();">
                                        <span class="text-xs text-red-500">{{$message}}</span>
                ...
                @endif
                <div>
                    <label class="block mb-2 text-sm font-medium disabled-select">Name of Concerned Employee</label>
        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 bottom-0 left-0 right-0 z-50 flex items-center justify-center hidden w-full h-full overflow-x-hidden overflow-y-auto bg-gray-800 bg-opacity-50">
            <div class="relative bg-white rounded-lg shadow w-full max-w-md h-56">
                <!-- Modal header -->
                ...
                <div class="grid grid-cols-1 gap-4 mb-4 p-4">
                    ...
                    <button id="updateButton" type="submit" class="inline-flex items-center font-medium text-white hover:bg-red-600 hover:text-white bg-customRed rounded-8px text-sm px-5 py-2.5 me-2 shadow justify-self-end">
                        Update
                    </button>
                </div>
            </div>
        ...
        <div id="popup-modal" tabindex="-1" class="fixed top-0 bottom-0 left-0 right-0 z-50 flex items-center justify-center hidden w-full h-full overflow-x-hidden overflow-y-auto bg-gray-800 bg-opacity-50">
            <div class="relative bg-white rounded-lg shadow w-full max-w-md h-56  flex justify-center flex-col">
                ...
                <form wire:submit.prevent="submit" method="POST" class="p-4">
                    <div class="p-4 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal disabled-select">Are you sure you want to proceed</h3>
                        <button type="submit" class="text-white bg-customRed hover:bg-red-600 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                            Yes
                        </button>
                        <button type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:disabled-select focus:z-10 focus:ring-4 focus:ring-gray-100">No</button>
                    </div>
                </form>
            </div>
        </div>
        <div id="toast-success" tabindex="-1" class="fixed z-50 flex items-center justify-center hidden w-full max-w-xs p-4 disabled-select transform -translate-x-1/2 bg-white rounded-lg shadow top-4 left-1/2" role="alert">
