        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="grid grid-cols-1 min-[902px]:grid-cols-6 gap-4">
                <div class="col-span-1 min-[902px]:col-span-2">
                    <label for="firstname" class="block mb-2 text-sm font-medium text-gray-900 whitespace-nowrap">First name</label>
                    <input type="text" name="firstname" id="firstname"  value="{{$first_name}}" required="" disabled
                        class="bg-gray-50 border border-gray-300 text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                </div>
                <div class="col-span-1 min-[902px]:col-span-2">
                    <label for="middlename" class="block mb-2 text-sm font-medium text-gray-900 whitespace-nowrap">Middle name</label>
                    <input type="text" name="middlename" id="middlename" value="{{$middle_name}}" required="" disabled
                        class="bg-gray-50 border border-gray-300 text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                </div>
                <div class="col-span-1 min-[902px]:col-span-2">
                    <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900 whitespace-nowrap">Last name</label>
                    <input type="text" name="lastname" id="lastname"  value="{{$last_name}}" required="" disabled
                        class="bg-gray-50 border border-gray-300 text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                </div>
                <div class="col-span-1 min-[902px]:col-span-3">
                    <label for="employee_email" class="block mb-2 text-sm font-medium text-gray-900 whitespace-nowrap">Employee Email</label>
                    <input type="text" name="employee_email" id="employee_email"  value="{{$employee_email}}" required="" disabled
                        class="bg-gray-50 border border-gray-300 text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                </div>
                <div class="col-span-1 min-[902px]:col-span-3">
                    <label for="employee_id" class="block mb-2 text-sm font-medium text-gray-900 whitespace-nowrap">Employee ID</label>
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-4">
                <div class="col-span-2">
                    <label for="application_date" class="block mb-2 text-sm font-medium text-gray-900">Date of Filing</label>
                    <input type="date" wire:model="application_date" class="bg-gray-50 border shadow-inner border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                        placeholder="Date of Filing" required disabled>
                </div>
                <div class="col-span-2">
                    <label class="block mb-2 text-sm font-medium text-gray-900">Ticket Type</label>
                    <select id="type_of_ticket" name="type_of_ticket" wire:model="type_of_ticket" id="type_of_ticket_container" required wire:change="resetTypeOfRequest" disabled
                        class="bg-gray-50 border disabled-select border-gray-300 shadow-inner  text-sm rounded-lg block w-full p-2.5">
                ...
                @if ($type_of_ticket == "HR Internal")
                    <div id="type_of_request_container" class="col-span-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900"> Type of HR Internal Request</label>
                        <select name="type_of_request" wire:model.live="type_of_request" required wire:change="resetSubTypeOfRequest" disabled
                            class="bg-gray-50 border border-gray-300 text-gray-900 disabled-select shadow-inner text-sm rounded-lg block w-full p-2.5" style="color: #6B7280;">
                            <option selected>Select</option>
                    ...
                    @if ($type_of_request == "HR")
                        <div id="sub_type_of_request_container" class="col-span-2">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Type of HR Requests</label>
                            <select name="sub_type_of_request" wire:model.live="sub_type_of_request" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                    ...
                    @elseif ($type_of_request == "Office Admin")
                        <div id="sub_type_of_request_container" class="col-span-2">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Type of Office Admin Requests</label>
                            <select name="sub_type_of_request" wire:model.live="sub_type_of_request" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                    ...
                    @elseif ($type_of_request == "Procurement")
                        <div id="sub_type_of_request_container" class="col-span-2">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Type of Procurement Requests</label>
                            <select name="sub_type_of_request" wire:model.live="sub_type_of_request" required disabled
                                class="bg-gray-50 border border-gray-300 disabled-select text-gray-900 text-sm shadow-inner rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "Internal Control")
                    <div id="type_of_request_container" class="col-span-2 lg:col-start-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900">Type of Internal Control Request</label>
                        <select name="type_of_request" wire:model.live="type_of_request" required wire:change="resetSubTypeOfRequest" disabled
                            class="bg-gray-50 border border-gray-300 disabled-select text-gray-900 shadow-inner text-sm rounded-lg w-full p-2.5">
                            <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "HR Operations")
                    <div id="type_of_request_container" class="col-span-2 lg:col-start-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900">Type of HR Operations Request</label>
                        <select name="type_of_request" wire:model.live="type_of_request" required wire:change="resetSubTypeOfRequest" disabled
                            class="bg-gray-50 border border-gray-300 disabled-select text-gray-900 text-sm shadow-inner rounded-lg block w-full p-2.5">
                            <option selected>Select</option>
        ...
        @if ((($type_of_ticket == "Internal Control" || $type_of_ticket == "HR Operations") && !is_null($type_of_request)) || ($type_of_ticket == "HR Internal" && !is_null($type_of_request) && !is_null($sub_type_of_request)))
            ...
            <div class="flex flex-col gap-4">
                ...
                @if ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Certificate of Employment")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Purpose of Requesting CoE</label>
                        ...
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_request" class="block mb-2 text-sm font-medium text-gray-900">Commutation</label>
                            <div class="grid w-full grid-cols-2 p-4 border border-gray-300 shadow-inner rounded-lg bg-gray-50">
                                <div>
                                    <input type="radio" class="text-gray-900 border-gray-500" name="type_of_hrconcern" id="with_compensation" wire:model="type_of_hrconcern" value="With Compensation" disabled>
                                    <label for="with_compensation" class="text-sm font-medium text-gray-900">With Compensation</label>
                                </div>
                                <div>
                                    <input type="radio" class="ml-2 text-gray-900 border-gray-500" id="without_compensation" name="type_of_hrconcern" wire:model="type_of_hrconcern" value="Without Compensation" disabled>
                                    <label for="without_compensation" class="text-sm font-medium text-gray-900">Without Compensation</label><br>
                                </div>
                            </div>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "HMO-related concerns")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm shadow-inner font-medium text-gray-900">Type of HMO Concern</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_request" wire:model.live="type_of_hrconcern" class="bg-gray-50 border disabled-select border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">HMO Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">HMO Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Payroll-related concerns")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium text-gray-900">Payroll Date</label>
                            <input class="bg-gray-50 border border-gray-300 shadow-inner text-gray-900 text-sm rounded-lg block w-full p-2.5"
                        ...
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium text-gray-900">Type of Payroll Concern</label>
                            <div id="type_of_hrconcern_container">
                                <select name="type_of_request" wire:model.live="type_of_hrconcern" disabled
                                    class="bg-gray-50 border disabled-select border-gray-300 text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Payroll Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">Payroll Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Leave concerns")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium text-gray-900">Type of Leave Request</label>
                            <div id="type_of_hrconcern_container">
                                <select name="type_of_request" wire:model.live="type_of_hrconcern" disabled
                                    class="bg-gray-50 border disabled-select border-gray-300 text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Leave Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">Leave Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Request for Consultation")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium text-gray-900">Type of Consultation Request</label>
                            <div id="type_of_hrconcern_container">
                                <select name="type_of_request" wire:model.live="type_of_hrconcern" disabled
                                    class="bg-gray-50 border disabled-select border-gray-300 text-gray-900 shadow-inner  text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Consultation Concern Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "HR" && $sub_type_of_request == "Request for a Meeting")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium text-gray-900">Date of Meeting</label>
                        ...
                        <div id="request_requested_container" class="col-span-1">
                            <label for="request_requested" class="block mb-2 text-sm font-medium text-gray-900">Target Person</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="request_requested" wire:model="request_requested" class="bg-gray-50 border shadow-inner disabled-select  border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Purpose of Meeting</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Certificate of Remittances")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium text-gray-900">Type of Remittance Certificate</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border shadow-inner disabled-select  border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div class="col-span-1">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium text-gray-900">Account Assigned</label>
                            <div id="request_assigned_container">
                                <select disabled name="request_assigned" wire:model.live="request_assigned" class="bg-gray-50 border shadow-inner disabled-select border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Purpose of Requesting</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 shadow-inner bg-gray-50 rounded-lg border border-gray-300">
                                </textarea>
                        ...
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium text-gray-900">Date Start</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 shadow-inner text-sm rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Government-mandated benefits concern")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium text-gray-900">Type of GMR Concern</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border shadow-inner disabled-select border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">GMR Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Messengerial")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-6">
                        <div class="col-span-1 lg:col-span-2">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium shadow-inner text-gray-900"> Type of Messengerial Request</label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border disabled-select border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="request_assigned_container" class="col-span-1 lg:col-span-2">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium text-gray-900">Contact Person</label>
                        ...
                        <div id="request_others_container"  class="col-span-1 lg:col-span-3">
                            <label for="request_extra" class="block mb-2 text-sm font-medium text-gray-900">Address of Messengerial Destination</label>
                        ...
                        <div class="col-span-1 lg:col-span-3">
                            <label for="request_date" class="block mb-2 text-sm font-medium text-gray-900">Date of Messengerial Pick Up or Send Off</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                                    <span class="text-xs text-red-500">{{$message}}</span>
                                </div>
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Repairs/Maintenance")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_assigned" class="block mb-2 text-sm font-medium text-gray-900">Type of Repairs and Maintenance Request </label>
                            <div id="type_of_hrconcern_container">
                                <select disabled name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 border disabled-select shadow-inner border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Concerned Area</label>
                            <div id="purpose">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Book a Car")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        ...
                        <div id="account_client_hr_ops_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Passenger/s Name</label>
                            <div id="purpose">
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Address of Destination</label>
                            <div id="purpose">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Office Admin" && $sub_type_of_request == "Book a Meeting Room")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium text-gray-900">Start Date</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                        ...
                        <div class="col-span-1">
                            <label for="request_requested" class="block mb-2 text-sm font-medium text-gray-900">End Date</label>
                            <input type="date" name="request_requested" id="request_requested" wire:model.live="request_requested" required disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_requested')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('request_requested_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('request_requested_container').focus();">
                        ...
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium text-gray-900">Type of Room</label>
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Purpose of Booking</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                            ...
                            <div id="supplies_request.ballpen_black_container">
                                <div class="grid items-center grid-cols-2">
                                    ...
                                    <input type="number" id="supplies_request.ballpen_black" name="supplies_request.ballpen_black" wire:model="supplies_request.ballpen_black" disabled
                                        class="p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Procurement" && $sub_type_of_request == "Request for Quotation")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_hrconcern" class="block mb-2 text-sm font-medium text-gray-900">Quotation Specifications</label>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">Quotation Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "HR Internal" && $type_of_request == "Procurement" && $sub_type_of_request == "Request to Buy/Book/Avail Service")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">Service Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Reimbursements")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium text-gray-900">Cut-Off Date</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Reimbursement Description</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-inner border border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">Reimbursement Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" placeholder="(payslips,timesheet.etc.)" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border shadow-inner border-gray-300">
                                </textarea>
                                @error('request_link')
                                    <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('request_link_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('request_link_container').focus();">
                                        <span class="text-xs text-red-500">{{$message}}</span>
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Tools and Equipment")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="condition_availability" class="block mb-2 text-sm font-medium text-gray-900">Condition/Availability</label>
                            <div class="grid w-full grid-cols-2 p-4 border border-gray-300 rounded-lg shadow-inner bg-gray-50">
                                <div>
                                    <input disabled type="radio" class="text-gray-900 border-gray-500" name="condition_availability" id="new" wire:model="condition_availability" value="New">
                                    <label for="New" class="text-sm font-medium text-gray-900">New</label>
                                </div>
                                <div>
                                    <input disabled type="radio" class="text-gray-900 border-gray-500" id="Old/Existing Unit" name="condition_availability" wire:model="condition_availability" value="Old/Existing Unit">
                                    <label for="Old/Existing Unit" class="text-sm font-medium text-gray-900">Old/Existing Unit</label><br>
                                </div>
                            </div>
                            @error('type_of_hrconcern')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('type_of_hrconcern_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('type_of_hrconcern_container').focus();">
                        ...
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Equipment Type</label>
                            <select disabled id="type_of_hrconcern" name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 disabled-select shadow-inner border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Cash Advance")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="request_date" class="block mb-2 text-sm font-medium text-gray-900">Date of Cash Advance Request</label>
                            <input type="date" name="request_date" id="request_date" wire:model.live="request_date" required disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm shadow-inner rounded-lg block w-full p-2.5">
                            @error('request_date')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('time_period_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('time_period_container').focus();">
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">Cash Advance Concern Link</label>
                            <div id="request_link">
                                <textarea type="text" rows="2" id="request_link" name="request_link" wire:model="request_link" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300">
                                </textarea>
                ...
                @elseif ($type_of_ticket == "Internal Control" && $type_of_request == "Liquidation")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Liquidation Coverage</label>
                            <div id="purpose">
                                <textarea type="text" rows="2" id="purpose" name="purpose" wire:model="purpose" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border shadow-inner  border-gray-300">
                                </textarea>
                        ...
                        <div id="request_link_container" class="col-span-1">
                            <label for="request_link" class="block mb-2 text-sm font-medium text-gray-900">Liquidation Concern Link</label>
                            <div id="request_link">
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Performance Monitoring Request")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="col-span-1">
                            <label for="type_of_pe_hr_ops" class="block mb-2 text-sm font-medium text-gray-900">Type of Performance Monitoring Request</label>
                            <div id="type_of_pe_hr_ops_container">
                                <select disabled name="type_of_pe_hr_ops" wire:model.live="type_of_pe_hr_ops" class="bg-gray-50 disabled-select border shadow-inner border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                        ...
                        <div class="col-span-1">
                            <label for="account_client_hr_ops" class="block mb-2 text-sm font-medium text-gray-900">Type of Client's Account</label>
                            <div id="account_client_hr_opscontainer">
                                <select disabled name="account_client_hr_ops" wire:model.live="account_client_hr_ops" class="bg-gray-50 disabled-select border shadow-inner border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                    <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Incident Report")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="type_of_hrconcern_container" class="col-span-1">
                            <label for="type_of_hrconcerns" class="block mb-2 text-sm font-medium text-gray-900">Level of Offense</label>
                            <div class="grid w-full grid-cols-3 p-4 border border-gray-300 rounded-lg shadow-inner bg-gray-50">
                                <div>
                                    <input disabled type="radio" class="text-gray-900 border-gray-500" name="High" id="new" wire:model="type_of_hrconcern" value="High">
                                    <label for="High" class="text-sm font-medium text-gray-900">High</label>
                                </div>
                                <div>
                                    <input disabled type="radio" class="text-gray-900 border-gray-500" id="Medium" name="type_of_hrconcern" wire:model="type_of_hrconcern" value="Medium">
                                    <label for="Medium" class="text-sm font-medium text-gray-900">Medium</label><br>
                                </div>
                                <div>
                                    <input disabled type="radio" class="text-gray-900 border-gray-500" id="Low" name="type_of_hrconcern" wire:model="type_of_hrconcern" value="Low">
                                    <label for="Low" class="text-sm font-medium text-gray-900">Low</label><br>
                                </div>
                            </div>
                            @error('type_of_hrconcern')
                                <div class="text-sm transition transform alert alert-danger" x-data x-init="document.getElementById('type_of_hrconcern_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('type_of_hrconcern_container').focus();">
                        ...
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Incident Report</label>
                            <div id="purpose">
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Request for Issuance of Notice/Letter")
                    <div class="grid grid-cols-1 gap-4">
                        <div id="type_of_hrconcern_container">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Type of Notice</label>
                            <select disabled id="type_of_hrconcern" name="type_of_hrconcern" wire:model.live="type_of_hrconcern" class="bg-gray-50 disabled-select border shadow-inner border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                <option selected>Select</option>
                ...
                @elseif ($type_of_ticket == "HR Operations" && $type_of_request == "Request for Employee Files")
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div id="purpose_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Purpose of Employee Files</label>
                            <div id="purpose">
                                <textarea type="text" rows="5" id="purpose" name="purpose" wire:model="purpose" placeholder="(Please write the description)" disabled
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border shadow-inner border-gray-300">
                                </textarea>
                        ...
                        <div id="request_requested_container" class="col-span-1">
                            <label for="purpose" class="block mb-2 text-sm font-medium text-gray-900">Document/s Needed</label>
                            <div id="request_requested">
                ...
                @endif
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900">Name of Concerned Employee</label>
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <button @click="openConfirmation = false" type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                        </button>
