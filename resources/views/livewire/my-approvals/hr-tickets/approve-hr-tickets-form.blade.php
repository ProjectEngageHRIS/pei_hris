    ...
    <form wire:submit.prevent="submit" method="POST" class="flex flex-col gap-4 p-8 mt-10 bg-white rounded-lg">
        ...
        <div x-cloak x-data="{ openCrudModal: false, openConfirmation: false }" class="flex flex-row-reverse">
            ...
            <div x-data="{ showToast: false, toastType: 'success', toastMessage: '' }" 
                    @trigger-success.window="showToast = true; toastType = 'success'; toastMessage = 'HR Ticket Cancelled'; openConfirmation = false; openCrudModal = false; setTimeout(() => showToast = false, 3000)"
