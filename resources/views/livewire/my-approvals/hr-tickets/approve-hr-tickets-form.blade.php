<div>
    <nav class="flex mb-4" aria-label="Breadcrumb">
        ...
        <li aria-current="page">
            ...
            <span class="text-sm font-medium text-customGray ms-1 md:ms-2">Approve HR Ticket Form</span>
            </div>
        </li>
        </ol>
    </nav>
            ...
            <div class="relative bg-white rounded-lg shadow w-full max-w-md h-56  flex justify-center flex-col">
                ...
                <form wire:submit.prevent="submit" method="POST" class="p-4">
                    <div class="p-4 text-center">
                        ...
                        <button type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-500 focus:z-10 focus:ring-4 focus:ring-gray-100">No</button>
                    </div>
                </form>
            </div>
        </div>
