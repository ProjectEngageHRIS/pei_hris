<div>
    <nav class="flex mb-4" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{route('ItDashboard')}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-customRed md:ms-2 dark:text-gray-400 dark:hover:text-white">IT Dashboard</a>
            </div>
        </li>
        <li aria-current="page">
            ...
            <span class="ms-1 text-sm font-semibold text-gray-900 md:ms-2 dark:text-gray-400">Admin Edit</span>
            </div>
        </li>
        </ol>
    </nav> 
    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Edit IT Ticket</h2>
    <p class="mb-4 text-customRed font-semibold text-lg"> Ticket  <span class="text-customRed"># {{$form_id}}</span>  </p>

    <section class="bg-white dark:bg-gray-900 pb-8 px-8 mt-10 rounded-lg">
            ...
            {{-- <form wire:submit.prevent="submit" method="POST"> --}}
                ...
                <div class="grid  sm:grid-cols-3 ">
                    ...
                    <div class="grid w-full grid-cols-1 col-span-3">
                        <h2 class="font-bold text-customRed">Concern</h2>
                    ...
                    {{-- Report Information --}}
                    <div class="grid w-full grid-cols-1 col-span-3 ">
                        <h2 class="font-bold text-customRed">Report</h2>
                        <div id="report_container" class="mt-5">
                            <textarea type="text" rows="5" id="report" name="report" wire:model="report"
                            ...
                            @error('report')
                                <div class="text-sm transition transform alert alert-danger"
                                    x-data x-init="document.getElementById('report_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('report_container').focus();" >
                                        <span class="text-xs text-red-500" > {{$message}}</span>
                                </div>
                            @enderror
                        </div>
        ...
        <div x-cloak x-data="{ openCrudModal: false, openConfirmation: false, reportField: @entangle('status') }" class="flex flex-row-reverse">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <div class="grid grid-cols-1 gap-4 mb-4 ">
                            ...
                            <template x-if="reportField === 'Report'">
                                <div class="col-span-1">
                                    <label for="reports" class="block mb-2 text-sm font-medium text-customGray ">Report Details <span class="text-red-600">*</span></label>
                                    <textarea type="text" name="report" id="report" wire:model="report"
                                        class="bg-gray-50 border  border-gray-300  text-sm rounded-lg focus:ring-customRed focus:border-customRed block w-full p-2.5"> </textarea>
                                    @error('report')
            ...
            <div  x-show="openConfirmation" x-ref="confirmModal" tabindex="-1" class="fixed top-0 left-0 right-0 bottom-0 z-60 flex justify-center items-center overflow-y-auto overflow-x-hidden w-full h-full bg-gray-800 bg-opacity-50"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div x-data="{ showToast: false, toastType: 'success', toastMessage: '' }" 
                            @trigger-success.window="showToast = true; toastType = 'success'; toastMessage = 'IT Ticket Updated'; openConfirmation = false; openCrudModal = false; setTimeout(() => showToast = false, 3000)"
