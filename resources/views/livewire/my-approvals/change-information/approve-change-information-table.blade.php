        ...
        <div class="p-4 overflow-x-auto">
            <div class="inline-block min-w-full box-border">
                <div x-data="{
                    ...
                    }" class="flex flex-wrap items-center justify-between space-y-4 flex-column sm:flex-row min-[524px]:space-y-0">
