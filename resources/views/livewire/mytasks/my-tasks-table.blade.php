                                            ...
                                            @if ($my_task->status != "Cancelled")
                                                <div class="hidden  top-0 right-0 mt-2 z-40 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                            <li>
                                                                <a id="" onclick="location.href='{{ route('MyTasksView', ['index' => $my_task->uuid]) }}'"  class="block px-4 py-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">View</a>
                                                            </li>
                                                    </ul>
                                                    <div class="py-2">
