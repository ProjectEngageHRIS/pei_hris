    ...
    <div class="p-4 rounded-lg ">
        <nav class="flex mb-4" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{route('ItHelpDeskTable')}}" class="text-sm font-semibold text-gray-900 ms-1 hover:text-customRed md:ms-2 ">My Tasks</a>
                </div>
            </li>
            </ol>
        </nav>
        <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl ">My Tasks</h2>
                            ...
                            @endphp
                                <tr class="bg-white border-b hover:bg-gray-50 ">
                                    ...
                                    <td class="px-6 py-4 text-center whitespace-nowrap" colspan="3">
                                        <span  class="inline-flex items-center px-2 py-1 text-xs font-medium text-center text-green-900 rounded-lg bg-customGreen me-2 ">
                                    ...
                                    <td class="items-center py-4 text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            <!-- View Button -->
                                            <a onclick="location.href='{{ route('MyTasksView', ['index' => $my_task->uuid]) }}'" class="inline-flex items-center px-4 py-2 text-sm font-medium text-yellow-500 cursor-pointer hover:bg-yellow-700 focus:ring-4 focus:ring-gray-50">
                                                View
                                            </a>
                                        </div>
                                    </td>
