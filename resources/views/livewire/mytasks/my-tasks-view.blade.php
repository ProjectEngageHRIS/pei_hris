    ...
    <section class="bg-white dark:bg-gray-900 pb-10 px-8 mt-10 rounded-lg">
                                ...
                                <div class="grid grid-cols-1 min-[902px]:grid-cols-2 gap-4 col-span-3">
                                    <div class="w-full">
                                        <label for="task_title"
                                            class="block mb-2 text-sm font-medium disabled text-gray-900 whitespace-nowrap">Task Title <span class="text-red-600">*</span></label>
                                        <input type="text" disabled name="task_title" id="task_title"  wire:model="task_title"
                                ...
                                {{-- <div class="grid w-full grid-cols-1 gap-4 p-6 bg-white border border-gray-200 rounded-lg shadow "> --}}
                                    <div class="grid w-full grid-cols-1 col-span-3 ">
                                        <div id="assigned_task_container" class="grid grid-cols-1 gap-4 ">
                                            ...
                                            <textarea disabled type="text" rows="10" id="assigned_task" name="assigned_task" wire:model="assigned_task"
                                    ...
                                    <div class="grid grid-cols-1 min-[1052px]:grid-cols-2 gap-4 ">
                                        <div class="w-full">
                                            <label for="start_time"
                                                ...
                                                <span class="text-red-600">*</span></label>
                                            <input disabled type="datetime-local" name="start_time" id="start_time" wire:model.live="start_time"
                                        ...
                                        <div class="w-full" id="end_time_container">
                                            <label for="end_time"
                                                ...
                                                <span class="text-red-600">*</span></label>
                                            <input disabled type="datetime-local" name="end_time" id="end_time" wire:model.live="end_time"
                                                class="bg-gray-50 border border-gray-900 shadow-inner text-gray-900 text-sm rounded-lg focus:ring-customRed focus:border-customRed block w-full p-2.5 "
                                            required="">
                                            @error('end_time')
                                                <div class="text-sm transition transform alert alert-danger"
        ...
        {{-- <div x-cloak x-data="{ openCrudModal: false, openConfirmation: false }" class="flex flex-row-reverse mt-10">
            ...
            <div x-data="{ showToast: false, toastType: 'success', toastMessage: '' }" 
                    @trigger-success.window="showToast = true; toastType = 'success'; toastMessage = 'Task Edited'; openConfirmation = false; openCrudModal = false; setTimeout(() => showToast = false, 3000)"
