<div>
    <nav class="flex mb-4" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{route('AssignedTasksTable')}}" class="text-sm font-medium text-gray-700 ms-1 hover:text-customRed md:ms-2 \ ">My Tasks</a>
            </div>
        </li>
        <li aria-current="page">
            ...
            <span class="text-sm font-semibold text-customRed ms-1 md:ms-2 ">View Task</span>
            </div>
        </li>
        </ol>
    </nav>
    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl ">View Task</h2>
                                ...
                                <div class="grid grid-cols-1 min-[902px]:grid-cols-2 gap-4 col-span-3">
                                    <div class="w-full">
                                        <label for="task_title"
                                            class="block mb-2 text-sm font-semibold text-gray-500 whitespace-nowrap ">Task Title</label>
                                    ...
                                    <div wire:ignore class="">
                                        <label for="name" class="block mb-2 text-sm font-semibold text-gray-500 ">Target Employee</label>
                                        <select multiple style="width:100%; background:gray;" disabled class="js-example-basic-multiple mb-8 shadow-inner bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-customRed focus:border-customRed block w-full p-2.5">
                                ...
                                <div class="grid grid-cols-1 col-span-3 gap-4 ">
                                    <div class="grid w-full grid-cols-1 col-span-3 ">
                                        <div id="assigned_task_container" class="grid grid-cols-1 gap-4 ">
                                            ...
                                            class="block text-sm font-semibold text-gray-500 whitespace-nowrap ">Task</label>
                                            <textarea type="text" rows="10" id="assigned_task" name="assigned_task" wire:model="assigned_task" disabled
                                                ...
                                                class="block p-2.5 w-full text-sm shadow-inner border-gray-300 text-gray-500 bg-gray-50 rounded-lg ring-1 border-1 ring-gray-300 focus:border-customRed focus:ring-customRed ">
                                            </textarea>
                                            @error('assigned_task')
                                    ...
                                    <div class="grid grid-cols-1 min-[1052px]:grid-cols-2 gap-4 ">
                                        <div class="w-full">
                                            <label for="start_time"
                                                class="block mb-2 text-sm font-semibold text-gray-500 ">Start Date/Time</label>
                                            <input type="datetime-local" name="start_time" id="start_time" wire:model.live="start_time"  disabled
                                                class="bg-gray border border-gray-300 shadow-inner text-gray-500 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                                                required="">
                                            @error('start_time')
                                                <div class="text-sm transition transform alert alert-danger"
                                        ...
                                        <div class="w-full" id="end_time_container">
                                            <label for="end_time"
                                                class="block mb-2 text-sm font-semibold text-gray-500 ">End Date/Time</label>
