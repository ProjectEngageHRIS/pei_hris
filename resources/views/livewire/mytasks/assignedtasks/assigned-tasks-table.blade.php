<div class="main-content">
    <div class="p-4 rounded-lg dark:border-gray-700">
        ...
        <div class="flex justify-end">
            <button type="button" onclick="location.href='{{ route('TasksForm') }}'" class="text-customRed bg-white mb-8 hover:text-white hover:bg-customRed shadow font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">Assign a Task</button>
        </div>
                    ...
                    <div>
                        ...
                        @else
                            ...
                            @endphp
                                        ...
                                        @if ($my_task->status != "Cancelled")
                                            <div class="hidden  top-0 right-0 mt-2 z-40 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                        <li>
                                                            <a id="" onclick="location.href='{{ route('AssignedTasksView', ['index' => $my_task->uuid]) }}'"  class="block px-4 py-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">View</a>
                                                        </li>
                                                </ul>
                                                <div class="py-2">
                                ...
                                <div id="popup-modal_{{ $my_task->uuid }}" tabindex="-1" class="hidden fixed top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center overflow-y-auto overflow-x-hidden w-full h-full bg-gray-800 bg-opacity-50">
