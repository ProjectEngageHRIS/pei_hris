            ...
            <form wire:submit.prevent="submit" method="POST">
                        ...
                        <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                            ...
                            <div class="grid w-full grid-cols-1 col-span-3 gap-4 ">
                                        ...
                                        <div class="grid grid-cols-1 min-[902px]:grid-cols-3 w-full gap-4 ">
                                            <div class="w-full ">
                                                <label for="application_date"
                                                    class="block mb-2 text-sm font-medium text-customGray ">Date of Filing <span class="text-red-600">*</span></label>
                                            ...
                                            <div>
                                                <label
                                                        class="block mb-2 text-sm font-medium text-gray-900 ">Leave Type <span class="text-red-600">*</span></label>
                                            ...
                                            <div class="supervisor_email_container">
                                                <label
                                                        class="block mb-2 text-sm font-medium text-gray-900 ">Email of Supervisor <span class="text-red-600">*</span></label>
                                            ...
                                            <div id="date_earned_container" class="grid grid-cols-1 col-span-2 min-[902px]:grid-cols-2 gap-4 ">
                                                <div class="justify-center w-full">
                                                    <label for="inclusive_start_date"
                                                        class="block mb-2 text-sm font-medium text-gray-900 ">Date <span class="text-red-600">*</span></label>
                                                ...
                                                <div id="date_description_container" class="grid grid-cols-1 ">
                                                    <label for="earned_description"
                                                        class="block mb-2 text-sm font-medium text-gray-900 ">Date Earned Description <span class="text-red-600">*</span></label>
                                        ...
                                        <div>
                                            ...
                                            <div id="time_period_container" class="grid grid-cols-1 gap-4 ">
                                                <div class="grid grid-cols-1 min-[1052px]:grid-cols-4 gap-4 ">
                                                    <div class="w-full ">
                                                        <label for="inclusive_start_date"
                                                            class="block mb-2 text-sm font-medium text-gray-900 ">Date Requested <span class="text-red-600">*</span></label>
                                                    ...
                                                    <div class="w-full ">
                                                        <label for="inclusive_end_date"
                                                            class="block mb-2 text-sm font-medium text-gray-900 ">Actual Schedule <span class="text-red-600">*</span></label>
                                                    ...
                                                    <div id="purpose_type_container" >
                                                        <label
                                                                class="block mb-2 text-sm font-medium text-gray-900 ">Purpose <span class="text-red-600">*</span></label>
                                                    ...
                                                    <div id="deduct_to_container">
                                                        <label
                                                                class="block mb-2 text-sm font-medium text-gray-900 ">Deduct to? <span class="text-red-600">*</span></label>
                                    ...
                                    <div class="grid grid-cols-1 gap-4 min-[902px]:grid-cols-2 col-span-3">
                                        <div id="time_period_container" class="grid grid-cols-1 gap-4">
                                            ...
                                            <div class="grid grid-cols-1 min-[1052px]:grid-cols-2 gap-4 ">
                                                <div class="w-full">
                                                    <label for="inclusive_start_date"
                                                        class="block mb-2 text-sm font-medium text-gray-900 ">Start Date/Time <span class="text-red-600">*</span></label>
                                                    <input type="datetime-local" name="inclusive_start_date" id="inclusive_start_date" wire:model.live="inclusive_start_date"
                                                ...
                                                <div class="w-full">
                                                    <label for="inclusive_end_date"
                                                        class="block mb-2 text-sm font-medium text-gray-900 ">End Date/Time <span class="text-red-600">*</span></label>
                                                    <input type="datetime-local" name="inclusive_end_date" id="inclusive_end_date" wire:model.live="inclusive_end_date"
                                        ...
                                        <div id="leavecredits_container" class="grid grid-cols-1 gap-5 ">
                                            <h2 class="font-bold text-customRed">Leave Credits</h2>
                                            <div class="grid grid-cols-1 gap-4 min-[1052px]:grid-cols-3">
                                                <div class="w-full">
                                                    <label for="numOfWorkDays"
                                                        class="block mb-2 text-sm font-medium text-customGray ">Number of Days <span class="text-red-600">*</span></label>
                                                ...
                                                <div class="w-full">
                                                    <label for="available_credits"
                                                        class="block mb-2 text-sm font-medium text-customGray ">Available Credits <span class="text-red-600">*</span></label>
                                ...
                                <div id="reason_container" class="grid grid-cols-1 col-span-3 gap-5">
                                    <label for="reason"
                                    class="block font-bold whitespace-nowrap text-customRed ">Reason of Filing<span class="text-gray-900">   <span class="text-red-600">*</span></label>
                                    <textarea type="text" rows="10" id="reason" name="reason" wire:model="reason"
                                        ...
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 shadow-inner rounded-lg border border-gray-300 focus:ring-customRed focus:border-customRed" required>
                                    </textarea>
                                    @error('reason')
                                        <div class="text-sm transition transform alert alert-danger"
                ...
                <div id="toast-success" tabindex="-1" class="fixed inset-0 z-50 flex items-center justify-center hidden w-full h-full bg-gray-800 bg-opacity-50">
                    <div id="toast-success-checkin" class="fixed flex items-center justify-center w-full max-w-xs p-4 text-gray-500 transform -translate-x-1/2 bg-white rounded-lg shadow top-4 left-1/2 z-60 dark:text-gray-400 dark:bg-gray-800" role="alert">
                        ...
                        <div class="text-sm font-normal ms-3">Leave Request <br> Submitted Successfully</div>
