<div class="flex flex-col space-y-6">
    <div class="container w-full h-[200px] p-4 bg-white rounded-lg shadow">
        <div class="flex items-center space-x-2">
            <p class="text-sm font-semibold">Today is</p>
            <p class="text-sm font-semibold text-customRed">August 01, 2024</p>
            <p class="text-sm font-semibold">|</p>
            <p class="text-sm font-semibold text-customRed">7:40:02 AM</p>
        </div>

        <div class="flex mt-4 space-x-4">
            <span class="flex-grow">
                <p class="text-sm font-medium">No. of Absents</p>
            </span>
            <span class="flex-grow">
                <p class="text-sm font-medium">No. of Whole Day</p>
            </span>
            <span class="flex-grow">
                <p class="text-sm font-medium">No. of Overtime</p>
            </span>
            <span class="flex-grow">
                <p class="text-sm font-medium">No. of Undertime</p>
            </span>
            <span class="flex-grow">
                <p class="text-sm font-medium">No. of No Time Out</p>
            </span>
            <span class="flex-grow">
                <p class="text-sm font-medium">No. of On Leave</p>
            </span>
        </div>
    </div>
      <!-- Attendance Table -->
