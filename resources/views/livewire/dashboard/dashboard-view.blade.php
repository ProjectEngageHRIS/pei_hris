<div class="flex flex-col mt-10 lg:flex-row gap-y-6 lg:justify-center ns:items-stretch lg:items-start">
    ...
    <div class="grid grid-cols-1 gap-4">
        @if ($activities->isEmpty())
            <div class="lg:w-full lg:max-w-xl pt-5 text-center pb-5 bg-white rounded-lg shadow-lg mb-10 lg:mt-[-45px] ns:mt-[0px]">
    ...
    <!-- Pending Tasks -->
        <div class="mb-4 bg-white rounded-lg shadow-lg lg:w-64 ns:items-stretch">
            <div class="pt-4 pb-4">
                    ...
                    <div class="px-4">
                        @foreach ($tasks as $index => $task)
                            <div class="flex items-center my-2">
                                ...
                                <p class="ml-2 text-sm text-center text-customRed">{{ $task->task_title }}</p>
                            </div>
                        @endforeach
                    </div>
                @endif
                    ...
                    <div class="flex flex-col items-center mr-5">
                        @foreach ($leave_requests as $request)
                            <div class="flex items-center my-2">
                                ...
                                <p class="ml-2 text-xs text-center text-customRed">{{ $request->inclusive_start_date }}</p>
                                <p class="ml-2 text-xs text-center text-customRed">-</p>
                                <p class="ml-2 text-xs text-center text-customRed">{{ $request->inclusive_end_date }}</p>
                            </div>
                        @endforeach
                    </div>
                @endif
