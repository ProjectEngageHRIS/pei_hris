<div class="flex flex-col space-y-6">
    <div wire:ignore class="grid items-stretch grid-cols-1 gap-4 justify-items-stretch md:justify-items-center lg:justify-items-stretch md:grid-cols-2 lg:grid-cols-4">
        <!-- Employee Type -->
    ...
    <div class="relative shadow-md" x-data="{ showModal: false }">
        <div class="flex flex-row items-start justify-between w-full gap-4 p-4 bg-white rounded-t-lg">
            ...
            <div x-show="showModal"
                ...
                <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow" @click.stop>
                    <!-- Modal header -->
                    ...
                    <ol class="flex items-center justify-center w-full p-4">
                        ...
                        <li class="">
                            <div class="flex items-center justify-center text-xs border-2 rounded-full number-step size-5 border-customRed"> 7 </div>
                        </li>
                    </ol>
                    <!-- Modal body -->
                    <form wire:submit.prevent="submit" method="POST">
                        ...
                        <!-- Other Information -->
                        <div id="step-2" class="hidden mb-4 step">
                            <div class="flex flex-row justify-between">
                            ...
                            <div class="overflow-y-scroll h-[310px] p-2 pb-4 gap-2 flex flex-col">
                                ...
                                <hr class="my-4 border-gray-300">
                                <div class="flex flex-col gap-2" x-data="govtNamesForm()">
                                    <div class="flex flex-row justify-between">
                                    ...
                                    <template x-for="(govt, index) in govts" :key="index">
                                        <div class="flex flex-col gap-2">
                                            <div class="flex flex-row justify-between">
                                                ...
                                                <button class="pr-2 text-customGray1 hover:text-customRed" @click="removeGovt(index)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="size-4">
                                ...
                                <hr class="my-4 border-gray-300">
                                <div class="flex flex-col gap-2" x-data="trainingsNamesForm()">
                                    <div class="flex flex-row justify-between">
                                    ...
                                    <template x-for="(training, index) in trainings" :key="index">
                                        <div class="flex flex-col gap-2">
                                            <div class="flex flex-row justify-between">
                                                ...
                                                <button class="pr-2 text-customGray1 hover:text-customRed" @click="removeTraining(index)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="size-4">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                    </svg>
                                                </button>
                        ...
                        <!-- Family Background -->
                        <div id="step-3" class="hidden mb-4 step">
                            <div class="flex flex-row justify-between">
                            ...
                            <div class="overflow-y-scroll h-[310px] p-2 pb-4 gap-2 flex flex-col">
                                ...
                                <div class="flex flex-col gap-2" x-data="childrenNamesForm()">
                                    <div class="flex flex-row justify-between">
                                    ...
                                    <template x-for="(child, index) in children" :key="index">
                                        <div class="flex flex-col gap-2" wire:ignore>
                                            <div class="flex flex-row justify-between">
                                                ...
                                                <button class="pr-2 text-customGray1 hover:text-customRed" @click="removeChild(index)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="size-4">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                    </svg>
                                                </button>
                        ...
                        <!-- Emergency Contact -->
                        <div id="step-4" class="hidden mb-4 step">
                            <div class="flex flex-row justify-between">
                        ...
                        <!-- Work History -->
                        <div id="step-5" class="hidden mb-4 step" x-data="workHistoryForm()">
                            <div class="flex flex-row justify-between">
                            ...
                            <div class="overflow-y-scroll h-[310px] p-2 pb-4 gap-2 flex flex-col">
                                <template x-for="(work, index) in works" :key="index">
                                    <div class="flex flex-col gap-2">
                                        <div class="flex flex-row justify-between">
                                            <p class="text-sm font-semibold"> No. <span x-text="index+1"></span></p>
                                            <button class="pr-2 text-customGray1 hover:text-customRed" @click="removeWork(index)">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="size-4">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                </svg>
                                            </button>
                        ...
                        <!-- Onboarding -->
                        <div id="step-6" class="hidden mb-4 step">
                            <div class="flex flex-row justify-between">
                        ...
                        <!-- Company details -->
                        <div id="step-7" class="hidden mb-4 step">
                            <div class="flex flex-row justify-between">
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="items-center py-4 text-center">
                                    <div x-data="{ isOpen: false }" @click.away="isOpen = false" class="">
                                        ...
                                        <!-- Dropdown menu -->
                                        <div x-show="isOpen" class="absolute right-0 z-40 mt-2 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                            @if ($employee->status != "Cancelled")
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                    ...
                                                    <li>
                                                        <a id="cancel_button_{{ $employee->employee_id }}" class="block px-4 py-2 text-black cursor-pointer hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white" @click="openDeactivateModal('{{ $employee->employee_id }}')">Deactivate</a>
                                                    </li>
                                                </ul>
                                            @else
                                                <!-- Dropdown content -->
    ...
    <div x-data="{ showToast: false, toastType: 'success', toastMessage: '' }"
        ...
        <!-- Loading screen -->
        <div wire:loading wire:target="submit" class="z-50 load-over">
            <div wire:loading wire:target="submit" class="z-50 loading-overlay">
