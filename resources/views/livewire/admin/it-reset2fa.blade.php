<div class="mt-15 sm:mx-auto sm:max-w-md"> <!-- Adjusted mt-20 to mt-10 -->
    ...
    <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10 mt-4"> <!-- Adjusted mt-20 to mt-4 -->
        <div class="flex flex-col items-center">
            <h1 class="mt-4 text-xl font-bold text-customRed">Reset 2FA</h1>
        </div>

        <form wire:submit.prevent="reset2FA" class="mt-4"> <!-- Adjusted mt-6 to mt-4 -->
        ...
        <!-- Loading screen -->
        <div wire:loading wire:target="reset2FA" class="load-over">
            <div wire:loading wire:target="reset2FA" class="loading-overlay">
        ...
        <div x-cloak x-data="{ showToast: false, toastType: 'success', toastMessage: '' }" 
                @trigger-success.window="showToast = true; toastType = 'success'; toastMessage = 'OTP Reset Done Successfully';  cancelModal = false; setTimeout(() => showToast = false, 3000)"
