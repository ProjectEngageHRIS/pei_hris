    ...
    <nav class="flex justify-between items-center w-[99%] mx-auto">
                ...
                <div id="barDropdownMenu" class="absolute z-10 hidden w-40 mt-2 origin-top-right bg-white rounded-md shadow-lg center-0 ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div class="py-1">
                        <ul class="flex flex-col gap-y-1.5">
                            ...
                            <a href="{{ route('EmployeesTable') }}" class="block px-4 py-2 text-sm {{ request()->routeIs('EmployeesTable') ? 'text-customRed' : 'text-gray-600' }} hover:bg-customRed hover:text-white">
        ...
        <div class="invisible xl:visible xl:static absolute min-h-fit left-0 top-[9%] w-auto flex items-center px-5">
            <ul class="flex items-center gap-x-5">
                ...
                <a href="{{ route('EmployeesTable') }}" class="w-32">
                    <button class="w-32 font-sans text-sm font-medium shadow h-7 rounded-8px {{ request()->routeIs('EmployeesTable') ? 'bg-customRed text-white' : 'bg-navButton text-gray-600 hover:bg-customRed hover:text-white' }}">
        ...
        <div class="flex item-center gap-x-3.5">
            <!-- Notification -->
            <div class="relative inline-block text-left">
                <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="relative inline-flex items-center text-sm font-medium text-center text-gray-600 hover:text-customRed focus:outline-none" type="button">
                    ...
                    <div class="absolute block w-5 h-5 text-white border-2 border-white rounded-full bg-customRed -top-1.5 start-3 text-[10px]">2</div>
                </button>

                <!-- Dropdown menu -->
                <div id="dropdownNotification" class="absolute right-0 z-10 hidden w-64 mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-lg shadow-lg" aria-labelledby="dropdownNotificationButton">
                    <div class="block px-4 py-2 text-sm font-medium text-center text-gray-700 rounded-t-lg bg-gray-50"> Notifications </div>
                    <div class="divide-y divide-gray-100">
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="{{ asset( 'assets/defaultuser.png') }}" alt="Profile Picture">
                                <div class="absolute flex items-center justify-center w-5 h-5 -mt-5 border border-white rounded-full bg-customRed ms-6">
                            ...
                            <div class="w-full ps-3">
                                <div class="text-gray-500 text-xs mb-1.5">New task from <span class="font-semibold text-customGray1">Jese Leos</span>:"Compile documents"</div>
                                <div class="text-xs text-customRed">a few moments ago</div>
                            </div>
                        </a>
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100">
                            <div class="flex-shrink-0">
                    ...
                    <a href="#" class="block py-2 text-sm font-medium text-center rounded-b-lg text-customGray1 bg-gray-50 hover:bg-gray-100">
                        <div class="inline-flex items-center">
                            <svg class="w-4 h-4 text-sm text-gray-700 me-2" aria-hidden="true" xmlns="http:/    /www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
            ...
            <div class="relative inline-block text-left">
                ...
                <!-- Dropdown menu -->
                <div id="dropdownAvatarName" class="absolute right-0 z-10 hidden mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-lg shadow-lg w-44 top-12">
                    ...
                    <ul class="py-2 text-sm text-customGray1" aria-labelledby="dropdownAvatarNameButton">
                        <li>
                            <a href="{{route('EmployeeDashboard')}}" class="block px-4 py-2 hover:bg-customRed hover:text-white">Employee Portal</a>
                        </li>
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-customRed hover:text-white">Account Settings</a>
                        </li>
                    </ul>
                    <div class="py-2">
