                ...
                <div id="barDropdownMenu" class="absolute z-10 hidden w-40 mt-2 origin-top-right bg-white rounded-md shadow-lg center-0 ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div class="py-1">
                        <ul class="flex flex-col gap-y-1.5">
                            <a href="{{ route('EmployeeDashboard') }}" class="block px-4 py-2 text-sm text-gray-600 hover:bg-customRed hover:text-white">
                            ...
                            <a href="{{ route('AttendanceTable') }}" class="block px-4 py-2 text-sm text-gray-600 hover:bg-customRed hover:text-white">
                            ...
                            <div class="relative group">
                                <div id="requestBDropdownButton" class="block px-4 py-2 text-sm text-gray-600 cursor-pointer hover:bg-customRed hover:text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                            ...
                            <div class="relative group">
                                <div id="approveBDropdownButton" class="block px-4 py-2 text-sm text-gray-600 cursor-pointer hover:bg-customRed hover:text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                            ...
                            <a href="{{ route('PayrollTable') }}" class="block px-4 py-2 text-sm text-gray-600 hover:bg-customRed hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                            ...
                            <div class="relative group">
                                <div id="tasksBDropdownButton"class="block px-4 py-2 text-sm text-gray-600 cursor-pointer hover:bg-customRed hover:text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
        ...
        <div class="invisible xl:visible lg:static absolute min-h-fit left-0 top-[9%] w-auto flex items-center px-5">
            <ul class="flex items-center gap-x-5">
                ...
                <a href="{{ route('EmployeeDashboard') }}" class="w-32">
                    <button class="w-32 font-sans text-sm font-medium text-gray-600 shadow h-7 bg-navButton rounded-8px hover:bg-customRed hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                        <path fill-rule="evenodd" d="M8.543 2.232a.75.75 0 0 0-1.085 0l-5.25 5.5A.75.75 0 0 0 2.75 9H4v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 1 1 2 0v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V9h1.25a.75.75 0 0 0 .543-1.268l-5.25-5.5Z" clip-rule="evenodd" />
                        </svg> Home
                    </button>
                ...
                <a href="{{ route('AttendanceTable') }}" class="w-32">
                    <button class="w-32 font-sans text-sm font-medium text-gray-600 shadow h-7 bg-navButton rounded-8px h-114 hover:bg-customRed hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                            <path fill-rule="evenodd" d="M4 1.75a.75.75 0 0 1 1.5 0V3h5V1.75a.75.75 0 0 1 1.5 0V3a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2V1.75ZM4.5 6a1 1 0 0 0-1 1v4.5a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-7Z" clip-rule="evenodd" />
                        </svg> Attendance
                    </button>
                ...
                <!-- Requests Button -->
                <div class="relative inline-block text-left">
                    <button id="requestsDropdownButton" class="w-32 font-sans text-sm font-medium text-gray-600 shadow h-7 rounded-8px bg-navButton h-114 hover:bg-customRed hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                ...
                @if($role_id == 10)
                    <div class="relative inline-block text-left">
                        <button id="approveDropdownButton" class="w-32 font-sans text-sm font-medium text-gray-600 shadow h-7 rounded-8px bg-navButton h-114 hover:bg-customRed hover:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                                <path fill-rule="evenodd" d="M11.986 3H12a2 2 0 0 1 2 2v6a2 2 0 0 1-1.5 1.937V7A2.5 2.5 0 0 0 10 4.5H4.063A2 2 0 0 1 6 3h.014A2.25 2.25 0 0 1 8.25 1h1.5a2.25 2.25 0 0 1 2.236 2ZM10.5 4v-.75a.75.75 0 0 0-.75-.75h-1.5a.75.75 0 0 0-.75.75V4h3Z" clip-rule="evenodd" />
                                <path fill-rule="evenodd" d="M2 7a1 1 0 0 1 1-1h7a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7Zm6.585 1.08a.75.75 0 0 1 .336 1.005l-1.75 3.5a.75.75 0 0 1-1.16.234l-1.75-1.5a.75.75 0 0 1 .977-1.139l1.02.875 1.321-2.64a.75.75 0 0 1 1.006-.336Z" clip-rule="evenodd" />
                            </svg> Approvals
                ...
                <!-- Tasks Button -->
                <div class="relative inline-block text-left">
                    <button id="tasksDropdownButton" class="w-32 font-sans text-sm font-medium text-gray-600 shadow h-7 rounded-8px bg-navButton h-114 hover:bg-customRed hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="currentColor" class="inline-block w-5 h-5 mr-2">
                            <path fill-rule="evenodd" d="M11.986 3H12a2 2 0 0 1 2 2v6a2 2 0 0 1-1.5 1.937V7A2.5 2.5 0 0 0 10 4.5H4.063A2 2 0 0 1 6 3h.014A2.25 2.25 0 0 1 8.25 1h1.5a2.25 2.25 0 0 1 2.236 2ZM10.5 4v-.75a.75.75 0 0 0-.75-.75h-1.5a.75.75 0 0 0-.75.75V4h3Z" clip-rule="evenodd" />
                            <path fill-rule="evenodd" d="M2 7a1 1 0 0 1 1-1h7a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7Zm6.585 1.08a.75.75 0 0 1 .336 1.005l-1.75 3.5a.75.75 0 0 1-1.16.234l-1.75-1.5a.75.75 0 0 1 .977-1.139l1.02.875 1.321-2.64a.75.75 0 0 1 1.006-.336Z" clip-rule="evenodd" />
                        </svg> Tasks
