                            ...
                            @else
                                ...
                                @endphp
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                @if ($it_ticket->status != "Cancelled")
                                                    <div class="hidden  top-0 right-0 mt-2 z-40 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                        ...
                                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                                <li>
                                                                    <a id="" onclick="location.href='{{ route('ItHelpDeskView', ['index' => $it_ticket->uuid]) }}'"  class="block px-4 py-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">View</a>
                                                                </li>
                                                        </ul>
                                                        <div class="py-2">

                                                            <a id="cancel_button_{{ $it_ticket->uuid }}"  class="block px-4 py-2 cursor-pointer text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Cancel</a>
                                        ...
                                        <div id="popup-modal_{{ $it_ticket->uuid }}" tabindex="-1" class="hidden fixed top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center overflow-y-auto overflow-x-hidden w-full h-full bg-gray-800 bg-opacity-50">
