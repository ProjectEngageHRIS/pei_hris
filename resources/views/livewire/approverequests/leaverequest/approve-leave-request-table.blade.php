    ...
    <div class="p-4 rounded-lg dark:border-gray-700">
        <nav class="flex mb-4" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <svg class="w-3 h-3 mx-1 text-gray-900 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                </svg>
                <a href="{{route('ApproveLeaveRequestTable')}}" class="text-sm font-semibold text-gray-900 ms-1 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Approve Leave Request</a>
                </div>
            </li>
        ...
        <div class="w-full pb-4 overflow-x-auto bg-white rounded-t-lg shadow-md">
            <div class="flex flex-wrap items-center justify-between p-4 pb-4 space-y-4 flex-column sm:flex-row sm:space-y-0">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="table-search" wire:model.live="search" class="block p-2 text-sm text-gray-900 border border-gray-900 rounded-lg ps-10 w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search like: 2024-01-01 ">
                </div>
            </div>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 ">
                                <th scope="col" colspan="11" class="justify-center" style="padding-bottom: 40px">
                                    <div class="flex justify-center " style="padding-top: 40px">
                                        ...
                                        <p class="items-center text-xl font-semibold text-blue-500 "> Nothing To Show</p>
                                    </div>
                                </th>
                            </tr>
                        @else
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <th scope="row" class="px-6 py-4 font-medium text-center text-gray-900 capitalize whitespace-nowrap dark:text-white">
                                        <span  class="inline-flex items-center px-2 py-1 text-xs font-medium text-center text-gray-200 bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 me-2 dark:bg-red-300 dark:hover:bg-red-600 dark:focus:ring-red-800">
                                            <svg class="w-6 h-6 mr-1 text-white dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    {{-- <a onclick="location.href='{{ route('ipcredit', ['index' => $leaverequest->id]) }}'"  class="font-medium text-blue-600 cursor-pointer dark:text-blue-500 hover:underline">Edit</a> --}}
                                        {{-- <a href="{{route('ipcredit', $leaverequest)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                        {{-- <a wire:click="removeIpcr({{$leaverequest->id}})" class="font-medium text-red-600 cursor-pointer dark:text-red-500 hover:underline ms-3">Remove</a> --}}
                                        ...
                                        <td class="items-center py-4 text-center">
                                            ...
                                            <div class="top-0 right-0 z-10 hidden mt-2 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                <!-- Dropdown content -->
